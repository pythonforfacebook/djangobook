...
def test_parse_signed_request():
    ...
    from djangobook.utils import parse_signed_request
...
def test_get_facebook_profile():
    from djangobook.utils import get_facebook_profile
...
def test_facebook_post_method_override():    
    ...
    from djangobook.middleware import FacebookMiddleware
...
def test_djangobook_registers_user():
    from django.test.client import RequestFactory
    from djangobook.middleware import FacebookMiddleware
    from djangobook.models import User
...
def test_djangobook_registers_oauth_token():
    from django.test.client import RequestFactory
    from djangobook.middleware import FacebookMiddleware
    from djangobook.models import OAuthToken
